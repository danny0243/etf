...
const CACHE = 'etf-shell-v20260609n';
const SHELL = [
  '/',
  '/css/style.css?v=20260609n',
  '/css/auth.css?v=20260609n',
  '/js/app.js?v=20260609n',
  '/js/etf-auth.js?v=20260609n',
  '/js/pwa.js?v=20260609n',
  '/js/config.js?v=20260609n',
  '/icons/icon-192.png',
  '/icons/icon-512.png',
];
