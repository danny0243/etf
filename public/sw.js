...
const CACHE = 'etf-shell-v20260609o';
const SHELL = [
  '/',
  '/css/style.css?v=20260609o',
  '/css/auth.css?v=20260609o',
  '/js/app.js?v=20260609o',
  '/js/etf-auth.js?v=20260609o',
  '/js/pwa.js?v=20260609o',
  '/js/config.js?v=20260609o',
  '/icons/icon-192.png',
  '/icons/icon-512.png',
];
