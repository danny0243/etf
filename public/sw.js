...
const CACHE = 'etf-shell-v20260609j';
const SHELL = [
  '/',
  '/css/style.css?v=20260609j',
  '/css/auth.css?v=20260609j',
  '/js/app.js?v=20260609j',
  '/js/etf-auth.js?v=20260609j',
  '/js/pwa.js?v=20260609j',
  '/js/config.js?v=20260609j',
  '/icons/icon-192.png',
  '/icons/icon-512.png',
];
