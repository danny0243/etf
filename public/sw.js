...
const CACHE = 'etf-shell-v20260609k';
const SHELL = [
  '/',
  '/css/style.css?v=20260609k',
  '/css/auth.css?v=20260609k',
  '/js/app.js?v=20260609k',
  '/js/etf-auth.js?v=20260609k',
  '/js/pwa.js?v=20260609k',
  '/js/config.js?v=20260609k',
  '/icons/icon-192.png',
  '/icons/icon-512.png',
];
