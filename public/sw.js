...
const CACHE = 'etf-shell-v20260610r';
const SHELL = [
  '/',
  '/css/style.css?v=20260610r',
  '/css/auth.css?v=20260610r',
  '/js/app.js?v=20260610r',
  '/js/etf-auth.js?v=20260610r',
  '/js/pwa.js?v=20260610r',
  '/js/config.js?v=20260610r',
  '/icons/icon-192.png',
  '/icons/icon-512.png',
];
